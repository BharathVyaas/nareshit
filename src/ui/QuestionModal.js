...
function QuestionModal({ data: questionData, setter: setQuestionData }) {
  ...
  return (
    <div className="absolute w-[60%] overflow-x-hidden h-[80vh] scroll scroll-sharp overflow-scroll bg-white rounded-lg shadow-lg p-8 top-[20%] left-[20%]" onClick={(e) => e.stopPropagation()}>
     <div className="flex justify-end"><CloseIcon fontSize="large" onClick={() => setQuestionData(false)} className="cursor-pointer" /></div>
